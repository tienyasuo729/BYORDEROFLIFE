...
public class Check {
    ...
    // nếu cccd thì sẽ sắp xếp lại mảng danh sách employee
    public static String checkIntInPut(String regex, int IfCCCD) { // kiểm tra int nhập vào có bị lỗi về cố tình nhập chữ hay vượt phạm vi int không { theo regex }
        String input = null;
        boolean check = true;
        do {
    ...
    public static String checkIntInPut(String regex) { // kiểm tra int nhập vào có bị lỗi về cố tình nhập chữ hay vượt phạm vi int không { theo regex }
        String input = null;
        boolean check = true;
        do {
            input = scanner.nextLine();
