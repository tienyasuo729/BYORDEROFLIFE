...
public class UsbUtil
{
	 ...
	 */
	public static UsbDevice synchronizedUsbDevice(UsbDevice usbDevice) { return new SynchronizedUsbDevice(usbDevice); }
	 ...
	 */
	public static UsbPipe synchronizedUsbPipe(UsbPipe usbPipe) { return new SynchronizedUsbPipe(usbPipe); }
