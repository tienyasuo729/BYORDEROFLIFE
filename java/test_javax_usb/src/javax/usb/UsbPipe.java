 ...
 * Data flows in the
 * {@link UsbEndpoint#getDirection() direction}
 * defined by the associated {@link #getUsbEndpoint() endpoint}, except for Control
 * {@link UsbEndpoint#getType() type} pipes.
 * <p>
...
public interface UsbPipe
{
	 ...
	 * {@link UsbConfiguration#isActive() active configuration} and
	 * {@link UsbInterface#isActive() interface setting}, otherwise it is inactive.
	 ...
	 * {@link UsbEndpointDescriptor#wMaxPacketSize() maximum packet size}.
	 * <p>
	 ...
	 * Short packets indicate either the end of data or an error.
	 * <p>
	 * If this is a Control {@link UsbEndpoint#getType() type} pipe,
	 * the UsbIrp must be a {@link UsbControlIrp UsbControlIrp}.
	 ...
	 * <p>
	 * If this is a Control {@link UsbEndpoint#getType() type} pipe,
	 * the UsbIrps must be {@link UsbControlIrp UsbControlIrps}.
