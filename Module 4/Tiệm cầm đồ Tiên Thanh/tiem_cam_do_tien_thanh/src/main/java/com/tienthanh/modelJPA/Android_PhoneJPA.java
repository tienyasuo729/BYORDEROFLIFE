package com.tienthanh.modelJPA;
...
public class Android_PhoneJPA {
    ...
    public Android_PhoneJPA() {
    }

    public Android_PhoneJPA(String id, String name_owner, String name_phone, String id_of_phone, int price, Date start_Date, String phone_number_owner, String status, String password, String note) {
        this.id = id;
