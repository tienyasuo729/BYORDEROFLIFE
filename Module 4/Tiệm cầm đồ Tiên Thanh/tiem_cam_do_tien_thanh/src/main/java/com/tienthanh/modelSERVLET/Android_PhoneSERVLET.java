package com.tienthanh.modelSERVLET;

import java.util.Date;

public class Android_PhoneSERVLET {
    private String id;
    ...
    public Android_PhoneSERVLET(String id, String name_owner, String name_phone, String id_of_phone, int price, Date start_Date, String phone_number_owner, String status, String password, String note) {
        this.id = id;
