package com.tienthanh.modelJDBC;
...
public class Android_PhoneJDBC{
    private String id;
    ...
    public Android_PhoneJDBC() {
    }

    public Android_PhoneJDBC(String id, String name_owner, String name_phone, String id_of_phone, int price, Date start_Date, String phone_number_owner, String status, String password, String note) {
        this.id = id;
