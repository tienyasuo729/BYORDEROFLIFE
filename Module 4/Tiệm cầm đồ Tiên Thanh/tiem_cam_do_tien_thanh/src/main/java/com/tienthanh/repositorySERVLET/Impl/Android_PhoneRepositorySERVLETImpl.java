package com.tienthanh.repositorySERVLET.Impl;



import com.tienthanh.repositorySERVLET.IAndroid_PhoneRepositorySERVLET;
import com.tienthanh.connectionsSERVLET.BaseRepositorySERVLET;
...
//    private String DELETE_HISTORY = "INSERT INTO LichSuThayDoi (Action, DuLieuCu, DuLieuMoi) VALUES (?, ?, ?)";
    ...
    public List<Android_PhoneSERVLET> displayAndroid_Phone() {
        ...
        try {
            ...
            while (resultSet.next()){
                ...
                androidPhoneList.add(new Android_PhoneSERVLET(id,name_owner,name_phone,id_of_phone,price,start_Date,phone_number_owner,status,password,note));
            }
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    ...
    public void add_New_Android_Phone(Android_PhoneSERVLET android_phoneServlet) {
        try {
            ...
            preparedStatement.setInt(4, android_phoneServlet.getPrice());
            preparedStatement.setDate(5, new java.sql.Date(android_phoneServlet.getStart_Date().getTime()));
            preparedStatement.setString(6, android_phoneServlet.getStatus());
            preparedStatement.setString(7, android_phoneServlet.getPassword());
            preparedStatement.setString(8, android_phoneServlet.getNote());
            preparedStatement.executeUpdate();
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    ...
    public void edit_Android_Phone(Android_PhoneSERVLET androidPhoneSERVLET) {
        try {
            ...
            preparedStatement.setDate(4,new java.sql.Date(androidPhoneSERVLET.getStart_Date().getTime()));
            preparedStatement.setString(5,androidPhoneSERVLET.getStatus());
            preparedStatement.setString(6,androidPhoneSERVLET.getPassword());
            preparedStatement.setString(7,androidPhoneSERVLET.getNote());
            preparedStatement.setString(8,androidPhoneSERVLET.getId());
            preparedStatement.executeUpdate();
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    ...
    public List<Android_PhoneSERVLET> list_Find_Android_Phone_Similar_By_Id(String id) {
        ...
        try {
            ...
            while (resultSet.next()){
                ...
                String password = resultSet.getString("password");
                String note = resultSet.getString("note");
                androidPhoneList.add(new Android_PhoneSERVLET(find_by_id,name_owner,name_phone,id_of_phone,price,start_Date,phone_number_owner,status,password,note));
            }
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
